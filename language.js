...
function langNew() {
    ...
    if (x.innerText == "BM") {
      ...
      document.getElementById("textsnapshot-lang").src = "https://nooralizahbj.github.io/Digital-Skin-Advisor-Cetaphil/assets/INTRO BM.png";
      document.getElementById("start-button").innerText = "MULAKAN";

    // Frame 2
      document.getElementById("how-lang").innerText = "BAGAIMANA IA BERFUNGSI";
      document.getElementById("guide-lang").src = "https://nooralizahbj.github.io/Digital-Skin-Advisor-Cetaphil/assets/Guide BM.png";
    ...
    if (x.innerText == "EN") {
      ...
      document.getElementById("textsnapshot-lang").src = "https://nooralizahbj.github.io/Digital-Skin-Advisor-Cetaphil/assets/INTRO CARD.png";
      document.getElementById("start-button").innerText = "GET STARTED";

      // Frame 2
      document.getElementById("how-lang").innerText = "HOW IT WORKS";
      document.getElementById("guide-lang").src = "https://nooralizahbj.github.io/Digital-Skin-Advisor-Cetaphil/assets/Guide.png";
